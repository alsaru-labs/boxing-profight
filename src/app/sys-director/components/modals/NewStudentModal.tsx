      ...
      >
        ...
        <DialogHeader className="p-8 pb-0 relative z-10">
          ...
          <DialogDescription className="text-white/40 font-medium italic">
            {invitationUrl ? "¡Registro completado con éxito!" : "Añade los datos básicos para enviarle su acceso a la plataforma."}
          </DialogDescription>
        </DialogHeader>
          ...
          {invitationUrl ? (
            <div className="space-y-6 py-4 animate-in fade-in slide-in-from-bottom-4">
              <div className="p-6 bg-emerald-500/10 border border-emerald-500/20 rounded-[1.5rem] space-y-4">
                <p className="text-[10px] font-black uppercase tracking-widest text-emerald-500 text-center">Acceso Directo Generado</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex flex-row gap-3 pt-2">
                ...
                >
                  {isUpdating ? <Loader2 className="w-5 h-5 animate-spin" /> : "REGISTRAR"}
                </Button>
              </div>
            </form>
          )}
