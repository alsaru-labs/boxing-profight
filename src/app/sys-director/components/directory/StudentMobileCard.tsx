        ...
        <div className="shrink-0 flex flex-col gap-2">
          {student.phone && (
              <a
                ...
                className="flex items-center justify-center h-10 w-10 rounded-xl bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20 transition-all active:scale-95 hover:bg-[#25D366]/20 shadow-lg shadow-[#25D366]/5"
                title="WhatsApp"
              >
